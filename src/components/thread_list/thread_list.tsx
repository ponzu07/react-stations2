...
const thread_list = () => {
  ...
  return (
    <div className="space-y-4">{threads.map(thread =>( 
      <div key={thread.id} className="rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-gray-800 p-4 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700" >
